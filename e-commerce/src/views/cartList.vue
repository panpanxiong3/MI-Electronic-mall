<template>
  ...
  <div>
              ...
              <li v-for="carts in cartList" >
                <div class="cart-tab-1">
                  ...
                  <div class="cart-item-pic">
                    <img :src="'/static/' + carts.productImage">
                  </div>
                  <div class="cart-item-title">
                    <div class="item-name">{{carts.productName}}</div>
                  </div>
                </div>
                ...
                <div class="cart-tab-5">
                  <div class="cart-item-opration">
                    <a href="javascript:;" class="item-edit-btn" @click="delCart(carts.productId)">
    ...
    <model :mdshow="showModel" @close="colseModel">
        <p slot="modelName">确定删除</p>
      <div slot="colseModel">
        <a href="javascript:;" class="btn btn--m" @click="removeList">删除</a>
        <a href="javascript:;" class="btn btn--m" @click="colseModel">关闭</a>
      </div>
        <div>
...
<script>
    ...
    export default{
        ...
        methods:{
            ...
            removeList(){
                axios.post('/users/delList',{'cartId':this.productId}).then((resprons)=>{
                     let res = resprons.data;
                     if(res.status == '0'){
                         this.showModel =false;
                         this.getList();
                     }
